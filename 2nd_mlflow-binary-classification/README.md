...
![Parallel Coordinates Plot](images/parallel coordinates plot.png)

---

## 2️⃣ Model Accuracy Comparison

Comparison of accuracy scores for all trained models.
...
```bash
git clone https://github.com/manasranjanmeher99/mlflow-binary-classification.git
```

Move to project directory:

```bash
cd mlflow-binary-classification
```
